...
//                <input id="chkfile< ?php print $fid ? >" type="checkbox" name="chkfile" value="< ?php print $fid ? >" onClick="updateCheckedItems(this)">
                ...
                <span class="filedetailslink">
                    <xxxa id="listingFilenameRec<?php print $fid ?>" class="filedetailsdialog" href="<?php print $details_link_parms ?>" TITLE="Click to view details"><?php print $file_name ?></xxxa>
                </span>
