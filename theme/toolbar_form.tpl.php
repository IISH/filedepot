...
<div style="float:left;padding-left:0px;margin-top:-2px">
  <form name="frmtoolbar" action="#" method="post" style="margin:0px;">
    ...
    <div class="floatleft" style="padding-top:5px;width:160px;">
	    <!-- DISABLED4IISG // -->
      <XXXselect id="multiaction" class="form-select disabled_element" name="multiaction" style="padding:0px;width:100%;" onChange="if (checkMultiAction(this.value)) submit(); postSubmitMultiactionResetIfNeed(this.value);" disabled="disabled"><option value="0">test</option></XXXselect>
    </div>
  </form>
</div>
